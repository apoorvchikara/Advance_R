...
We have used the **iris** dataset for this project, which is available in the `datasets` package in R. This dataset contains measurements of various attributes for different species of iris flowers.
